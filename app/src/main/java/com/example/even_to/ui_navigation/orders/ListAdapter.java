...
public class ListAdapter extends RecyclerView.Adapter{
    ...
    public int getItemCount() {
        return OrderData.ServiceProviderImages.length;
    }
    private class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindView(int position){
            mServiceProviderImage.setImageResource(OrderData.ServiceProviderImages[position]);
            mServiceProviderName.setText(OrderData.ServiceProviderName[position]);
            mServiceProviderDescription.setText(OrderData.ServiceProviderDescription[position]);
            mServiceProviderCategory.setText(OrderData.ServiceProviderCategory[position]);
        }
